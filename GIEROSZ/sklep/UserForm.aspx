<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserForm.aspx.cs" Inherits="sklep.WebForm5" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ListView ID="lvStore" runat="server" DataSourceID="Orders">
                <EmptyDataTemplate>
                    <table runat="server" style="background-color: #FFFFFF;border-collapse: collapse;border-color: #999999;border-style:none;">
                        <tr class="empty">
                            <td class="tdTitleNumber">Nie masz żadnych zamówień</td>
                        </tr>
                    </table>
                </EmptyDataTemplate>
                <LayoutTemplate>
                ...
                <tr>
                    <td class="tdTitleNumber">Numer zamównienia</td>
                    <td class="tdTitleNumber"><%# Eval("id_zamow") %></td>
                </tr>
                <tr>
                    <td class="tdTitle">Produkty</td>
                    <td class="tdData"><%# Eval("nazwy_prod") %></td>
                </tr>
                <tr>
                    <td class="tdTitle">Cena</td>
                    <td class="tdData"><%# Eval("cena") %></td>
                </tr>
                <tr>
                    <td class="tdTitle">Dostawca</td>
                    <td class="tdData"><%# Eval("metoda_dost") %></td>
                </tr>
                <tr>
                    <td class="tdTitle">Płatność</td>
                    <td class="tdData"><%# Eval("metoda_plat") %></td>
                </tr>
                <tr>
                    <td class="tdTitle">Adres</td>
                    <td class="tdData"><%# Eval("adres") %></td>
                </tr>
                <tr>
                    <td class="tdTitle">Miasto</td>
                    <td class="tdData"><%# Eval("miasto") %></td>
                </tr>
                <tr>
                    <td class="tdTitle">Kod</td>
                    <td class="tdData"><%# Eval("kod") %></td>
                </tr>
                <tr>
