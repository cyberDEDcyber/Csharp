<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogOut.aspx.cs" Inherits="sklep.WebForm4" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <h1 class="text">Czy chcesz sie Wylogować?</h1>
        <asp:Button ID="btLogOut" runat="server" Text="Wyloguj" Width="108px" BackColor="#F9683A" ForeColor="White" OnClick="btLogOut_Click"/>
    </form>
